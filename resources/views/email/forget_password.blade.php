...
<body
    ...
    {{-- <span class="preheader"
        ...
        Verifikasi Email Musim Seni Salihara / Email verification .</span> --}}
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"
                                            ...
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                Klik tombol di bawah untuk melakukan reset password.
                                            </p>
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;font-style:italic">
                                                Please click this button to proccedd password reset.
                                            </p>
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #3498db;"
                                                                            ...
                                                                            bgcolor="#3498db"> <a
                                                                                href="{{ $url }}"
                                                                                target="_blank"
                                                                                style="border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #3498db; border-color: #3498db; color: #ffffff;">Reset
                                                                                Password</a> </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                            ...
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                Jika anda merasa tidak pernah melakukan lupa password, mohon abaikan
                                                email ini.
                                            </p>
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;font-style:italic">
                                                If you haven’t forgot password, no further action is required
                                            </p>
                                            <br>
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                Jika tombol “Reset Password” tidak berfungsi, salin dan tempel tautan
